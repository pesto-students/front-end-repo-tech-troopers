...
import { ngoDetailsSchema } from '../../validations/auth.validation';
...
const Registration = () => {
  ...
  const {
    ...
    mode: 'onBlur',
    resolver: yupResolver(ngoDetailsSchema),
  });
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                >
                  <VStack flex={1} spacing={4} alignItems='stretch'>
                    ...
                    <FormControl
                      id='ngoName'
                      isInvalid={!!errors?.ngoDetails?.ngoName}
                    >
                      <Input
                        type='text'
                        name='ngoDetails.ngoName'
                        placeholder='NGO Name'
                        h='4rem'
                        {...register('ngoDetails.ngoName')}
                        style={{ backgroundColor: 'white' }}
                      />
                      <FormErrorMessage>
                        {errors?.ngoDetails?.ngoName?.message}
                      </FormErrorMessage>
                    </FormControl>
                    ...
                    <FormControl
                      id='typeOfNGO'
                      isInvalid={!!errors?.ngoDetails?.typeOfNGO}
                    >
                      <Select
                        placeholder='Type of NGO'
                        name='ngoDetails.typeOfNGO'
                        size='lg'
                        h='4rem'
                        {...register('ngoDetails.typeOfNGO')}
                        style={{ backgroundColor: 'white' }}
                      >
                      ...
                      <FormErrorMessage>
                        {errors?.ngoDetails?.typeOfNGO?.message}
                      </FormErrorMessage>
                    </FormControl>
                    <FormControl
                      id='addressLine2'
                  ...
                  <VStack flex={1} spacing={4} alignItems='stretch'>
                    ...
                    <FormControl
                      ...
                      isInvalid={!!errors?.ngoDetails?.registrationNumber}
                    >
                      <Input
                        type='text'
                      ...
                      />
                      <FormErrorMessage>
                        {errors?.ngoDetails?.registrationNumber?.message}
                      </FormErrorMessage>
                    </FormControl>
                    {/* Address */}
                    <FormControl
