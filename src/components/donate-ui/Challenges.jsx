...
const Challenges = () => {
  return (
    <div className='w-[900px] my-8 mx-auto'>
      <h3 className='pb-4 text-dark font-shippori text-3xl font-extrabold'>
        Challenge
      </h3>
      <p className='pb-8 text-gray-dark font-work text-xl font-normal'>
